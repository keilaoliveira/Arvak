...
public class GrupoResource {
	...
	public ResponseEntity<Page<GrupoDTO>> findPage(
			...
			@RequestParam(value="orderBy", defaultValue="descricaoGrupo") String orderBy, 
			@RequestParam(value="direction", defaultValue="ASC") String direction) {	
		Page<Grupo> list = service.findPage(page, linesPerPage, orderBy, direction);
		Page<GrupoDTO> listDto = list.map(obj -> new GrupoDTO(obj));
		return ResponseEntity.ok().body(listDto);			
	}
